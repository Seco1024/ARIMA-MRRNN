...
best_model = load_model(os.path.join(parent_dir, f'models/{str(today)}/transformer.h5'))
...
for file in os.listdir(tmp_dir):
    ...
    original_path = os.path.join(parent_dir, f'data/preprocessed_data(majorbuyer)/{file}')
