...
for file in os.listdir(tmp_dir):
    ...
    if random.random() < 0.01:
        lstm_tools.visualize_prediction_plot()
...
df_error.to_csv(os.path.join(parent_dir, f'out/hybrid_model_error/{str(today)}_{str(args.neurons)}_{str(args.double_layer)}_{str(args.l2)}'))